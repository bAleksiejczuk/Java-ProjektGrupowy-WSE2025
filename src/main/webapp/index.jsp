  ...
  <nav id="menu">
    <div id="inner-menu">
      <div id="left-side-nav">
        ...
        <h2 id="welcome">Cześć, <a href="my_profile.jsp" id="username"><span id="linkers-name" title="Imię godne prawdziwego linkera!"><% if(session.getAttribute("user") != null) { %> ${ user.name} <% } %></span><!--Niech wstawia session name/login--></a><span class="i s12 y"> !</span></h2>
      </div>
      <div id="buttons">

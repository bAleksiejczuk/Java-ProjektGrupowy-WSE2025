...
<div id="wrapper">
    ...
    <main>
        <div id="inner-main">
            <header>Ranking <a id="top-linker" href="index.jsp" title="TopLinker czyli aplikacja do topowych linków!"><span id="top">Top</span><span id="linker">Linker</span></a> !</header>

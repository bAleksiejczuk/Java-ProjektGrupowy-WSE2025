...
<div id="wrapper">
    ...
    <main>
        <div id="inner-main">
            <header>Rejestracja do <a id="top-linker" href="index.jsp" title="TopLinker czyli aplikacja do topowych linków!"><span id="top">Top</span><span id="linker">Linker</span></a> !</header>
            <div id="desc">Po rejestracji otrzymasz dostęp do pełni aplikacji!</div>
            <div id="content">
                <div id="inner-content">
                    <form id="login-form" action="/login" method="POST">
                        <div class="form-group">
                            <input autocomplete="off" type="text" class="login-input" name="login" placeholder="Login" required>
                        </div>

                        <div class="form-group">
                            <input autocomplete="off" type="text" class="login-input" name="username" placeholder="E-mail" required>
                        </div>

                        <div class="form-group">
                            <input autocomplete="off" type="password" class="login-input" name="password" placeholder="Hasło" required>
                        </div>

                        <div class="form-group">
                            <input autocomplete="off" type="password" class="login-input" name="password-repeat" placeholder="Powtórz hasło" required>
                        </div>

                        <button type="submit" class="btn-1 center-row">Zarejestruj</button>
                    </form>
